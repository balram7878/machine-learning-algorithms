...
class MyLogisticLasso:
    def __init__(self, lr=0.01, epochs=2000, alpha=1.0):
        self.lr = lr
        self.epochs = epochs
        self.alpha = alpha
        self.weights = None
...
sk_model = LogisticRegression(penalty='l1', solver='liblinear', max_iter=1000)
sk_model.fit(X_train, y_train)
sk_pred = sk_model.predict(X_test)

print("--- Sklearn Lasso Logistic ---")
...
print("\n--- Custom Lasso Logistic ---")
print(f"{'Alpha':<10} {'Acc':>10} {'F1':>10}")

models = {}

for alpha in alphas:
    model = MyLogisticLasso(alpha=alpha, lr=0.05, epochs=3000)
